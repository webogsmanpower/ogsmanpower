...
Route::post('candidateStripe', [StripeController::class, 'candidateStripe'])->name('candidateStripe');
Route::post('bilangualStripe', [StripeController::class, 'bilangualStripe'])->name('bilangualStripe');
...
Route::controller(ManualPaymentController::class)->group(function () {
    ...
    Route::post('/candidate/manual/payment', 'candidatePaymentPlace')->name('candidate.manual.payment');
    Route::post('/bilangual/manual/payment', 'bilangualPaymentPlace')->name('bilangual.manual.payment');
