...
Route::middleware('auth:user', 'verified', 'otp.verified')->group(function () {
    // Dashboard Route
    Route::get('/user/dashboard', [WebsiteController::class, 'dashboard'])->name('user.dashboard')->middleware('prevent_cache');
    ...
    Route::controller(CompanyController::class)->prefix('company')->middleware(['company'])->name('company.')->group(function () {
        ...
        Route::middleware('company.profile', 'has_plan')->group(function () {
            ...
            // Route::post('job/applications', 'jobApplications')->name('job.application');
...
Route::controller(MessengerController::class)->middleware('auth:user', 'verified', 'otp.verified')->group(function () {
