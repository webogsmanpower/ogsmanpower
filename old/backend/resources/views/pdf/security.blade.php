                ...
                <div class="details-box">
                    ...
                    <div class="details-content">
                        ...
                        <div class="detail-row">
                            ...
                            <span class="detail-value">{{ ($height = $securityDetails['height'] ?? $seeker->height ?? $basic['height'] ?? '') ? $height . ' CM' : '' }}</span>
                            <div class="detail-arabic">الطول</div>
                        </div>
                        <div class="detail-row">
                            <span class="detail-label">WEIGHT</span>
                            <span class="detail-value">{{ ($weight = $securityDetails['weight'] ?? $seeker->weight ?? $basic['weight'] ?? '') ? $weight . ' KG' : '' }}</span>
                            <div class="detail-arabic">الوزن</div>
                        </div>
                        <div class="detail-row">
                            <span class="detail-label">CHEST SIZE</span>
                            <span class="detail-value">{{ ($chestSize = $securityDetails['chest_size'] ?? $basic['chest_size'] ?? '') ? $chestSize . ' CM' : '' }}</span>
