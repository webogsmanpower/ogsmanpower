                ...
                <div class="details-box">
                    ...
                    <div class="details-content">
                        ...
                        <div class="detail-row">
                            ...
                            <span class="detail-value"><?php echo e($seeker->number_of_children ?? ''); ?></span>
                            <div class="detail-arabic">عدد الأولاد</div>
                        </div>
                        <div class="detail-row">
                            <span class="detail-label">WEIGHT</span>
                            <span class="detail-value"><?php echo e(($weight = $seeker->weight ?? $basic['weight'] ?? '') ? $weight . ' KG' : ''); ?></span>
                            <div class="detail-arabic">الوزن</div>
                        </div>
                        <div class="detail-row">
                            <span class="detail-label">HEIGHT</span>
                            <span class="detail-value"><?php echo e(($height = $seeker->height ?? $basic['height'] ?? '') ? $height . ' CM' : ''); ?></span>
            ...
            <td class="right-column">
                ...
                <table class="data-table">
                    <tr>
                        ...
                        <td class="value-cell"><?php echo e(($resumeData['skill_washing'] ?? $seeker->skill_washing ?? false) ? 'YES' : 'NO'); ?></td>
                        <td class="arabic-cell">الغسيل</td>
                    </tr>
                    <tr>
                        <td class="label-cell">COOKING</td>
                        <td class="value-cell"><?php echo e(($resumeData['skill_cooking'] ?? $seeker->skill_cooking ?? false) ? 'YES' : 'NO'); ?></td>
                        <td class="arabic-cell">الطبخ</td>
                    </tr>
                    <tr>
                        <td class="label-cell">BABY SITTING</td>
                        <td class="value-cell"><?php echo e(($resumeData['skill_babysitting'] ?? $seeker->skill_babysitting ?? false) ? 'YES' : 'NO'); ?></td>
                        <td class="arabic-cell">رعاية الأطفال</td>
                    </tr>
                    <tr>
                        <td class="label-cell">CLEANING</td>
                        <td class="value-cell"><?php echo e(($resumeData['skill_cleaning'] ?? $seeker->skill_cleaning ?? false) ? 'YES' : 'NO'); ?></td>
                ...
                <div class="experience-box">
                    ...
                    <div class="experience-content">
                        <table class="work-experience-grid">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $experiences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <tr>
                                <td class="col-data"><?php echo e(strtoupper($exp['location'] ?? $exp['country'] ?? 'N/A')); ?></td>
                                <td class="col-data"><?php echo e(strtoupper($exp['role_title'] ?? $exp['role'] ?? $exp['job_title'] ?? 'N/A')); ?></td>
                                <td class="col-data">
                                    <?php
                                        $duration = '';
                                    ...
                                    ?>
                                    <?php echo e($duration ?: 'N/A'); ?>

                                </td>
                                <td class="col-data"><?php echo e(strtoupper($exp['company_name'] ?? $exp['company'] ?? 'N/A')); ?></td>
                            </tr>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            <tr>
...
<?php /**PATH /home/abdulbas/public_html/ogsmanpower.com/backend/resources/views/pdf/domestic.blade.php ENDPATH**/ ?>