...
<head>
    <meta charset="utf-8">
    <title>Domestic Worker Resume - <?php echo e($resumeData['first_name'] ?? ''); ?> <?php echo e($resumeData['last_name'] ?? ''); ?></title>
    <?php
...
<body>
    <!-- Header Section -->
    <div class="header">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($profilePhoto || $fullBodyPhoto): ?>
        <div style="float: right; margin-left: 20px; display: flex; gap: 10px;">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($fullBodyPhoto): ?>
            <div>
                <img src="<?php echo e($fullBodyPhoto); ?>" style="width: 80px; height: 120px; object-fit: cover; border: 1px solid #ccc;" alt="Full Body Photo">
        ...
        <div class="skills-grid">
            <div class="skill-category">
                ...
                <div class="skill-item">
                    <span class="skill-checkbox <?php echo e($resumeData['skill_washing'] ? 'checked' : ''); ?>"></span>
                    Laundry & Washing
                </div>
                <div class="skill-item">
                    <span class="skill-checkbox <?php echo e($resumeData['skill_cooking'] ? 'checked' : ''); ?>"></span>
                    Cooking
                </div>
                <div class="skill-item">
                    <span class="skill-checkbox <?php echo e($resumeData['skill_cleaning'] ? 'checked' : ''); ?>"></span>
                    House Cleaning
                </div>
                <div class="skill-item">
                    <span class="skill-checkbox <?php echo e($resumeData['skill_babysitting'] ? 'checked' : ''); ?>"></span>
                    Babysitting
                </div>
            </div>
            ...
            <div class="skill-category">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($resumeData['number_of_children'])): ?>
                    <div class="info-row">
                        <span class="info-label">Children:</span>
                        <?php echo e($resumeData['number_of_children']); ?>

                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($resumeData['date_of_birth'])): ?>
                    <div class="info-row">
                        <span class="info-label">Age:</span>
                        <?php echo e(\Carbon\Carbon::parse($resumeData['date_of_birth'])->age); ?> years
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        </div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($resumeData['height']) || !empty($resumeData['weight'])): ?>
    <div class="section">
        <div class="section-title">Physical Information</div>
        <div class="physical-info">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($resumeData['height'])): ?>
                <div class="info-row">
                    <span class="info-label">Height:</span>
                    <?php echo e($resumeData['height']); ?> cm
                </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($resumeData['weight'])): ?>
                <div class="info-row">
                    <span class="info-label">Weight:</span>
                    <?php echo e($resumeData['weight']); ?> kg
                </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($resumeData['chest_measurement'])): ?>
                <div class="info-row">
                    <span class="info-label">Chest:</span>
                    <?php echo e($resumeData['chest_measurement']); ?> cm
                </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    </div>
    ...
    <!-- Personal Qualities -->
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($resumeData['personal_qualities']) && is_array($resumeData['personal_qualities'])): ?>
    <div class="section">
        <div class="section-title">Personal Qualities</div>
        <div class="personal-qualities">
            <div class="qualities-list">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $resumeData['personal_qualities']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quality): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    <div class="quality-tag"><?php echo e($quality); ?></div>
    ...
    <div class="section">
        ...
        <p><?php echo e(is_array($resumeData['professional_summary']) ? (isset($resumeData['professional_summary']['summary']) ? $resumeData['professional_summary']['summary'] : (isset($resumeData['professional_summary']['text']) ? $resumeData['professional_summary']['text'] : collect($resumeData['professional_summary'])->flatten()->implode(' '))) : $resumeData['professional_summary']); ?></p>
    </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="qualities-list">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $resumeData['skills']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($skill['name'])): ?>
                    <div class="quality-tag"><?php echo e($skill['name']); ?></div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
        </div>
    </div>
    ...
    <!-- Availability Notes -->
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($resumeData['availability_notes'])): ?>
    <div class="section">
        <div class="section-title">Availability</div>
        <p><?php echo e($resumeData['availability_notes']); ?></p>
    </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</body>
</html>
<?php /**PATH /home/abdulbas/public_html/ogsmanpower.com/backend/resources/views/templates/resume/domestic.blade.php ENDPATH**/ ?>