                                    ...
                                    <form class="form-horizontal" action="{{ route('module.country.store') }}"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <small id="descriptionMessage" class="text-danger" style="display: none;">
                                                    You cannot write more than 200 characters.
                                                </small>
                                                @error('description')
...
@section('script')
    ...
    <script>
        document.getElementById('description').addEventListener('input', function () {
            ...
            // Show the warning message if the input exceeds 200 characters
            if (descriptionField.value.length > 200) {
