        ...
        <div v-if="show"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="sidebar-widget">
                                    <div class="row">
                                        <!-- <a name="" id="" class="btn btn-primary" href="#" role="button">Download Cv</a> -->
                                        <a class="btn btn-primary" @click="downloadCV" role="button" style="margin: 14px; font-size: 12px;">Download CV</a>
            ...
            <transition name="fade">
                <div v-if="candidateMessageModal"
                    class="tw-fixed tw-top-0 tw-left-0 tw-right-0 tw-z-50 tw-p-4 tw-overflow-y-auto md:tw-inset-0 h-modal md:tw-h-full tw-flex tw-items-center tw-justify-center tw-bg-gray-800 tw-bg-opacity-90 modal fade show"
                    id="messageModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
                    style="display: block;">
                        ...
                        <div class="modal-content">
                            <div class="chat-top tw-rounded-tl-xl tw-rounded-tr-xl tw-p-6 tw-bg-[#F1F2F4]">
                                ...
                                <a href="javascript:void(0)"
                                    ...
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <rect x="3" y="8" width="18" height="12" rx="1" stroke="#0066CC"
                                            stroke-width="2" />
                                        <rect x="8" y="4" width="8" height="4" rx="1" stroke="#0066CC"
                                            stroke-width="2" />
                                    </svg>
                                    <span>{{ job?.title ?? '' }}</span>
                                </a>
                            ...
                            <div class="chat-bottom tw-p-6 tw-bg-white tw-rounded-bl-xl tw-rounded-br-xl">
                                <form @submit.prevent="sendMessage()">
                                    <div class="form-group">
                                        <label for="chat" class="tw-text-sm tw-text-[#18191C] tw-mb-2">{{
                                            __('your_message') }}</label>
                                        <textarea v-model="message" id="chat" :placeholder="__('write_your_message')"
                                            value="" class="form-control" cols="1" rows="4"></textarea>
                                        <span class="invalid-feedback" role="alert"></span>
                                    </div>
                                    <div class="tw-mt-6 tw-flex tw-justify-between tw-items-center">
                                        <button @click="candidateMessageModal = false" type="button"
...
export default {
    ...
    methods: {
        ...
        downloadCV() {
            const candidateId = this.candidate.id; // Ensure candidate data is loaded
            ...
            const url = `/download-cv/${candidateId}`; // Match the Laravel route
