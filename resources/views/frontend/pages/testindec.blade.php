...
@section('main')
    <style>
        .carousel-nav {
            position: absolute;
            /* Ensures arrows are placed relative to the carousel */
            width: 100%;
        ...
        .candidate-carousel {
            margin-top: 20px;
            position: relative;
            /* Required for absolute positioning of arrow buttons */
        }
        ...
        .candidate-slide {
            padding: 10px;
            /* Add some padding between carousel slides */
        }
    </style>
                ...
                <div class="tab-pane show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                    @if ($candidates->count() > 0)
                        ...
                        <div style="position: relative">
                            ...
                            <!-- Candidate carousel positioned below the icons -->
                            <div class="candidate-carouse2">

                                @foreach ($candidates as $candidate)
                                    <div class="candidate-slide">
                                        <a onclick="showCandidateProfileModal('{{ $candidate->username }}')"
                                                ...
                                                <div class="rt-single-icon-box icb-clmn-lg tw-reltaive">
                                                    ...
                                                    <div class="iconbox-content !tw-m-0">
                                                        <div class="job-mini-title">
                                                            ...
                                                            @else
                                                                <span
                                                                    class="login_required">{{ maskFullName($candidate->username) }}</span>
                                                            @endif
                                                        </div>
                    ...
                    <div
                        ...
                        <div class="card-body">
                            <div class="rt-single-icon-box">
                                ...
                                <div class="iconbox-content">
                                    <div class="f-size-24 ft-wt-5">
                                        @if ($candidates > 0) //should be commented
                                        ...
                                        <span class="counter">{{ $candidates->count() }}</span>
                                        <span>+</span>
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            $('.candidate-carousel').slick({
                infinite: false, // Prevent infinite looping of candidates
                slidesToShow: 3, // Show 3 candidates on large screens
                slidesToScroll: 1,
                autoplay: false, // Disable autoplay
                prevArrow: $('.prev-arrow'), // Custom previous button
                nextArrow: $('.next-arrow'), // Custom next button
                responsive: [{
                        breakpoint: 1024,
                        settings: {
                            slidesToShow: 3, // Show 3 candidates on medium devices (tablets)
                            slidesToScroll: 1
                        }
                    },
                    {
                        breakpoint: 768,
                        settings: {
                            slidesToShow: 1, // Show 1 candidate on mobile
                            slidesToScroll: 1
                        }
                    }
                ]
