                                                    ...
                                                    @auth('user')
                                                        @if (auth()->user()->role == 'candidate')
                                                            @if (!$job->applied)
                                                                ...
                                                                @else
                                                                    <p>{{ 'You are not eligible for this job' }}</p>
                                                                @endif
                                                            @else
                            ...
                            <div class="col-sm-6 salery tw-salery-border">
                                ...
                                @if ($job->salary_mode == 'range')
                                    <h2>{{ getFormattedNumber($job->min_salary) }} -
                                        {{ getFormattedNumber($job->max_salary) }} {{ $job->currency }} </h2>
                                @else
                        ...
                        <div class="tw-share-area tw-px-8 tw-pt-6 tw-pb-8">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <span
                                    ...
                                    id="basic-addon2"><x-svg.link-sample-icon /></span>
                            </div>
                    ...
                    <div class="modal-body mt-3">
                        ...
                        <div class="from-group">
                            ...
                            {{-- @foreach ($resumes as $resume)
                                ...
                                @endforeach --}}
                            <select id="resume_format" class="rt-selectactive form-control w-100-p" name="resume_format">
                                ...
                                <option value="web_developer_format"> Professionl Format</option>
                                <option value="bike_rider_format">Bike Rider Format</option>
                                <option value="bilangual_format"> Bilangual Format</option>
