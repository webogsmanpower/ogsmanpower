                                    ...
                                    <a onclick="showCandidateProfileModal('{{ $candidate->user->username ?? '' }}')"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <x-svg.arrow-right-icon />
                                                            ...
                                                            {{-- <span class="body-font-4 text-primary-500">{{ __('Hire Me') }}
                                            <x-svg.arrow-right-icon />
                                        </span> --}}
                                                            <form action="{{ route('company.hire-request') }}"
                                                                ...
                                                                <input type="hidden" name="candidate_id"
                                                                    value="{{ $candidate->id }}">
                                                                <button type="submit" class="btn btn-primary">Hire
                                                                    Me</button>
                                                            </form>
                                                        @else
                                            ...
                                            <x-svg.arrow-right-icon />
                                                            ...
                                                            <span
                                                                class="body-font-4 text-primary-500 login_required">{{ __('Hire Me') }}
                                                                {{-- <x-svg.arrow-right-icon /> --}}
                                                            </span>
                                                        @endif
                                                    </div>
