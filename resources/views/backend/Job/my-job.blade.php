...
@section('content')
    ...
    <div class="dashboard-wrapper laptopscreen">
        <div class="container">
            <div class="row">
                    ...
                    <div class="dashboard-right tw-ps-0 lg:tw-ps-3">
                        <div class="dashboard-right-header rt-mb-32 mt-5">
                            ...
                            <form id="status-filter"
                                class="tw-flex tw-justify-between sm:tw-justify-end tw-gap-3 sm:tw-flex-nowrap tw-w-full tw-flex-wrap tw-items-center"
                                action="{{ route('company.myjob') }}" method="GET">
    ...
    <div class="job-listing mblscreen">
        <div class="  tw-w-full mt-2">
            <h3 class="f-size-18 lh-1 mb-0 tw-inline-flex">
                {{ __('my_jobs') }}
                <span class="text-gray-400">({{ $myJobs->total() }})</span>
            </h3>
            ...
            @foreach ($myJobs as $job)
                <div class="header">
                    ...
                    <div class="applicant-count">
                        <span> {{ $job->applied_jobs_count }}</span>
                        <p>Applicants</p>
                    </div>
