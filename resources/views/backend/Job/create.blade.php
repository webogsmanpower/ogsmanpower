                                        ...
                                        <div class="col-12">
                                            ...
                                            <select id="" name="title" class="select21"
                                                ...
                                                @foreach ($jobtitles as $jobtitle)
                                                    <option value="{{ $jobtitle->name }}">{{ $jobtitle->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            <input type="text" id="custom_product" name="custom_title"
                                                class="form-control" placeholder="Enter custom title" style="display:none;">
                                            @error('title')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ __($message) }}</strong>
                                                </span>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="max_age" class="form-control select2bs4" id="max_age"
                                                required>
