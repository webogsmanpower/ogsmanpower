                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row form-group">
                                        <div class="col-12">
                                            ...
                                            <input type="text" id="custom_product" name="custom_title" class="form-control"
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <select name="industry_type"
                                            ...
                                            @foreach ($industry_types as $type)
                                                <option {{ $type->name == $job->industry_type ? 'selected' : '' }}
                                                    value="{{ $type->name }}">
                                                    {{ $type->name }}
                                                </option>
                                            @endforeach
                                    ...
                                    <div class="card-body pt-0 row">
                                        <div class="col-12">
                                            ...
                                            @error('location')
                                                <span class="ml-3 text-md text-danger">{{ $message }}</span>
                                            @enderror
                                            <input type="checkbox" id="city_limit" name="city_limit"
                                                value="1" {{ $job->city_limit == 1 ? 'checked' : '' }}>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="checkbox" id="age_limit" name="age_limit"
                                                value="1" {{ $job->age_limit == 1 ? 'checked' : '' }}>
                                            Limit applications based on the selected value
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="gender"
                                                ...
                                                <option value="other" @if($job->gender == 'other') selected @endif>Other </option>
